class Team < ActiveRecord::Base
  ...
  def games
    home_games = Games.where(home_team_lineup_id: Lineup.select(:id).where(team_id: self.id))
    away_games = Games.where(away_team_lineup_id: Lineup.select(:id).where(team_id: self.id))
